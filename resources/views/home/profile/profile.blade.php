                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-sm-5">
                            <div class="form-login-group is-invalid">
                                ...
                                <input type="password" class="form-data-input form-data-phone " id="old" name="name" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-login-group is-invalid">
                                <i class="fas fa-key" aria-hidden="true"></i>
                                <input type="password" class="form-data-input form-data-phone " id="new" name="password" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
