<div class="bg-services">
    <div class="container">
        <h1 class="bg-services-title" data-aos="zoom-in">УСЛУГИ</h1>
        <div class="row">
            <div class="col-12 col-sm-4">
                <a href="/services/cargo" class="text-dark btn">
                    <div class="services-item" data-aos="flip-left">
                        <div class="services-item-img">
                            <img src="/img/img2.jpg" width="100%">
                            <div class="services-item-cloud">
            ...
            <div class="col-12 col-sm-4">
                <a href="/services/avia" class="text-dark btn">
                    <div class="services-item" data-aos="flip-left">
                        <div class="services-item-img">
            ...
            <div class="col-12 col-sm-4">
                <a href="/services/project" class="text-dark btn">
                    <div class="services-item" data-aos="flip-left">
                        <div class="services-item-img">
        ...
        <div class="row mt-4">
            <div class="col-12 col-sm-4">
                <a href="/services/project" class="text-dark btn">
                    <div class="services-item" data-aos="flip-right">
                        <div class="services-item-img">
              ...
              c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" fill="#fff"></path>
                        ...
                        <div class="services-item-title">
                            <h5>Складские логистические услуги</h5>
                            <div class="services-item-desc">Узнать больше</div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-12 col-sm-4">
                <a href="/services/russia" class="text-dark btn">
                    <div class="services-item" data-aos="flip-right">
                        <div class="services-item-img">
